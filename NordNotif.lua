...
if getgenv().NordUI then getgenv().NordUI:Destroy() end
local UI = New("ScreenGui", {
	["IgnoreGuiInset"] = true; ["Name"] = "NordNotifications"; ["ResetOnSpawn"] = false; ["ZIndexBehavior"] = "Global"
}); protectGui(UI); UI["Parent"] = Core.RobloxGui; getgenv().NordUI = UI;
...
function Nord:Notify(Title, Message, Type, Duration)
  Nord["Config"] = getgenv().NordConfig
